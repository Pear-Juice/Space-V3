...
public class CustomPostProcessPass : ScriptableRenderPass
{
    ...
    public CustomPostProcessPass(Shader shader, bool renderInEditor)
    {
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
    {
        ...
        if (customEffect.IsActive())
        {
            ...
            Debug.Log(customEffect.thickness.value);
            Debug.Log(customEffect.radius.value);
            Debug.Log(customEffect.color.value);
            // P.s. optimize by caching the property ID somewhere else
            material.SetFloat(Shader.PropertyToID("_Thickness"), customEffect.thickness.value);
            material.SetFloat(Shader.PropertyToID("_Radius"), customEffect.radius.value);
            material.SetColor(Shader.PropertyToID("_Color"), customEffect.color.value);
